...
```
ffmpeg -filter_complex ddagrab=framerate=60,hwdownload,format=bgra,scale=out_color_matrix=bt709:out_range=tv:flags=accurate_rnd+full_chroma_int+bitexact+lanczos -c:v h264_amf -profile:v high -quality balanced -qp_i 12 -qp_p 14 YYY.mp4
```
