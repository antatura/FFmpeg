...
```
ffmpeg -filter_complex ddagrab=framerate=60:dup_frames=0,hwdownload,format=bgra,scale=out_color_matrix=bt709:flags=accurate_rnd:out_range=tv -c:v h264_amf -profile:v high -quality balanced -qp_i 12 -qp_p 14 YYY.mkv
```
