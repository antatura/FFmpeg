...
```
ffplay -v 16 -fs -f lavfi "amovie=XXX.m4a,showspectrumpic,format=gbrp10le[A];amovie=XXX.wav,showspectrumpic,format=gbrp10le[B];[A][B]blend=all_mode=difference,eq=gamma=1.4"
```
