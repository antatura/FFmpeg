...
`-c:v libx265 -pix_fmt yuv420p10le -crf 20 -preset 8 -x265-params "open-gop=0:min-keyint=1:keyint=192:rd=4:ref=6:subme=5:rc-lookahead=60:rect=0:rskip=0:aq-mode=3:qcomp=0.65"`
